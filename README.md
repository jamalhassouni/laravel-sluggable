...
original source [eloquent-sluggable](https://github.com/cviebrock/eloquent-sluggable)
was written by [Colin Viebrock](http://viebrock.ca) and is released under the
[MIT License](LICENSE.md).

Add Support for Arabic by [Jamal Hassouni](https://github.com/jamalhassouni/)

Copyright (c) 2019 Jamal Hassouni
